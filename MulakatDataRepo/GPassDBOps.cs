...
namespace MulakatDataOps
{
    ...
    public class GPassDBOps : IGpassDB
    {
        ...
        {
             var cs = String.Format(ConfigurationManager.ConnectionStrings["MulakatPassUK.Properties.Settings.GPConnectionString"].ConnectionString, AppDomain.CurrentDomain.BaseDirectory);       
